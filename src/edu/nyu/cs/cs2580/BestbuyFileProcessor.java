...
/**
 * Extract all product from the html only contains the list
 * categories is extracted from url
...
public class BestbuyFileProcessor {
  ...
  /**
   * This method is used in crawler. Extract product lists from bestbuy pages
   * all other information is discarded at this stage to save space
   * @param html the webpage
