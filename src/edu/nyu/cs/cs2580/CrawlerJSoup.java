...
//                    BufferedWriter bw = new BufferedWriter(new FileWriter("data/bestbuy/pages/"+Integer.toString(docCount++), true));
//                    bw.write(prod);
//                    bw.flush();
                }
                break;
...
//                    BufferedWriter bw = new BufferedWriter(new FileWriter("data/amazon/pages/"+Integer.toString(docCount++), true));
//                    bw.write(prod);
//                    bw.flush();
                }
                break;
...
//            case "newegg":
//                Element itemList = p.getElementsByClass("items-view is-list").first();
//                if(itemList!=null){
//                    String prod = NewEggFilePreProcessor.extractProductsFrom(itemList.html());
//                    BufferedWriter bw = new BufferedWriter(new FileWriter("http_newegg/"+Integer.toString(docCount++), true));
//                    bw.write(prod);
//                    bw.flush();
//                }
//
