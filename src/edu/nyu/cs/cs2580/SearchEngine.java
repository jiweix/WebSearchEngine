...
public class SearchEngine {
  ...
  private static void parseCommandLine(String[] args)
    ...
    Check(MODE == Mode.SERVE || MODE == Mode.INDEX || MODE == Mode.CRAWL,
            "Must provide a valid mode: serve or index or run!");
  ...
  private static void startServing() throws IOException, ClassNotFoundException, InterruptedException {
  ...
  private static void startCrawling() throws IOException{
    CrawlerJSoup cjs1 = new CrawlerJSoup();
    CrawlerJSoup cjs2 = new CrawlerJSoup();
    URL amazon = new URL("https://www.amazon.com/electronics-store/b?ie=UTF8&node=172282");
    URL bestbuy = new URL("http://www.bestbuy.com");
    cjs1.setStartingURL(bestbuy);
