...
/**
 * Favorite ranker for product query uses cosine similarity as base score, then adjusted
 * using product rating, product category and product popularity (by twitter data)
 */
